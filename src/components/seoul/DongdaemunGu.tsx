...
export const DongdaemunGu = (props: React.SVGProps<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <use
        xlinkHref={`#kicon-dongdaemungu-a${sfx}`}
        style={{
          overflow: "visible",
          fill: `url(#kicon-dongdaemungu-b${sfx})`,
        }}
      />
      <clipPath id={`kicon-dongdaemungu-c${sfx}`}>
        <use
          xlinkHref={`#kicon-dongdaemungu-a${sfx}`}
          style={{
            overflow: "visible",
