import {
  ...
  // 세종
  Sejong,
  // 2026-07-01 행정구역 개편 신설 (공식 CI 공표 전 placeholder)
  JeonnamGwangju,
  JemulpoGu,
  YeongjongGu,
  SeohaeGu,
...
const iconData: InternalIconData[] = [
  ...
  },
  {
    ...
    name: "평택시",
    shortName: "평택",
    componentName: "PyeongtaekSi",
    component: PyeongtaekSi,
  },
  {
    code: 41650,
    regionCode: 41,
  ...
  },
  {
    ...
    name: "동두천시",
    shortName: "동두천",
    componentName: "DongducheonSi",
    component: DongducheonSi,
  },
  {
    code: 41370,
    regionCode: 41,
  ...
  },
  {
    ...
    name: "연천군",
    shortName: "연천",
    componentName: "YeoncheonGun",
    component: YeoncheonGun,
  },
  {
    code: 41830,
    regionCode: 41,
    name: "양평군",
    shortName: "양평",
    componentName: "YangpyeongGun",
    component: YangpyeongGun,
  },
  {
    code: 41820,
    regionCode: 41,
    name: "가평군",
    shortName: "가평",
    componentName: "GapyeongGun",
    component: GapyeongGun,
  },
  {
    code: 41610,
    regionCode: 41,
    name: "광주시",
    shortName: "광주",
    componentName: "GyeonggiGwangjuSi",
    component: GyeonggiGwangjuSi,
  },
  // 부산광역시
  {
    code: 26110,
  ...
  // ============================================
  // 2026-07-01 행정구역 개편 신설
  // ============================================
  // 인천광역시 신설 4구 (구 중구/동구/서구 재편 — 공식 로고 공표 전 placeholder)
  {
    code: 28125,
    regionCode: 28,
    name: "제물포구",
    shortName: "제물포",
    componentName: "JemulpoGu",
    component: JemulpoGu,
  },
  {
    code: 28155,
    ...
    name: "영종구",
    shortName: "영종",
    componentName: "YeongjongGu",
    component: YeongjongGu,
  },
  {
    code: 28275,
    regionCode: 28,
  ...
  },
  {
    ...
    name: "검단구",
    shortName: "검단",
    componentName: "GeomdanGu",
    component: GeomdanGu,
  },
  // 전남광주통합특별시 (구 광주 29xxx / 전남 46xxx의 신 코드 — 기관 존속으로 기존 로고 재사용)
  {
    code: 12110,
    regionCode: 12,
    name: "목포시",
